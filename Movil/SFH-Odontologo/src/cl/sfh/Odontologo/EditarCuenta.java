...
public class EditarCuenta extends Activity implements OnClickListener, OnItemSelectedListener
{
    ...
    private void inicializarElementos()
    {
    	...
    	spComuna = (Spinner)findViewById(R.id.spComuna);
    ...
    public void onClick(View v)
    {
    	switch (v.getId())
		{
			...
			case R.id.btnDatosContacto:
				...
				new guardarDatosContacto().execute(datosEditar.getIdPersona()+"",idComuna+"",edtFonoFijo.getText().toString(),edtFonoCelular.getText().toString(),edtDireccion.getText().toString(),edtCorreo.getText().toString(),datosEditar.getFechaIngreso());
    ...
    class guardarDatosPersona extends AsyncTask<String, Void, String>
    {
		...
		protected String doInBackground(String... params)
		{
			...
			ControladoraEditarDatosContacto editar = new ControladoraEditarDatosContacto();
