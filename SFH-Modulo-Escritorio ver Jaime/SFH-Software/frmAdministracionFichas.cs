...
namespace SFH_Software
{
    public partial class frmAdministracionFichas : Form
    {
        ...
        private void frmAdministracionFichas_Load(object sender, EventArgs e)
        {
           ...
           //Cargar Grillas 
            GrillaFicha.DataSource = this.client_fichas.ListarFichas();
        ...
        {
            Fichadental ficha = GrillaFicha.Rows[e.RowIndex].DataBoundItem as Fichadental;
            frmAdministracionTratamiento trata = new frmAdministracionTratamiento(ficha.IdFicha);
