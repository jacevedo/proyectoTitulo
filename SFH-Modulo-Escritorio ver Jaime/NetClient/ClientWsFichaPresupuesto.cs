...
*/
    ...
    public class ClientWsFichaPresupuesto
    {
        ...
        public List<Fichadental> ListarFichas() { 
            ...
            try{
                String result = netclient.NetPost("http://192.168.0.21/proyectoTitulo/sfhwebservice/webService/ws-ficha-presupuesto.php", "send={\"indice\":12}");
                ...
                foreach (var item in token)
                {
                    ...
                    if (item.SelectToken("habilitada").ToString() == "desabilitado")
                    {
                        ficha.Habilitada = 0;
                    }
                    else
