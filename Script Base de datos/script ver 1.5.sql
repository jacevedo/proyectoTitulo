...
--
-- Servidor: localhost
-- Tiempo de generación: 14-09-2013 a las 18:48:03
...
(2, 1, 1, '1991-12-12', 'Penisilina', 1),
(3, 3, 3, '2013-07-02', 'Presión baja', 1),
...
INSERT INTO `gastos` (`ID_GASTOS`, `ID_PERSONA`, `MONTO_GASTOS`, `DESCUENTO_GASTOS`) VALUES
(1, 1, 40000, 30000),
(2, 1, 30000, 40000),
(3, 1, 40000, 30000);
...
(5, 'Urgencia A Domicilio Id. Anterior', 29000),
...
(2, 3, 10000, '1991-12-12'),
(3, 3, 15000, '0000-00-00'),
(4, 4, 32000, '0000-00-00'),
(5, 3, NULL, '0000-00-00'),
(7, 3, 10000, '0000-00-00'),
...
(3, 3, '2013-07-02', 'Tratamiento Conducto', '2013-07-05', 50000),
