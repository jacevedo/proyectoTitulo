...
public class ListaPaciente extends Activity implements AdapterView.OnItemClickListener, OnClickListener
{
    ...
    {
		@Override
		protected ArrayList<Pacientes> doInBackground(Integer... params)
		{
			ControladoraPaciente controlPaciente = new ControladoraPaciente(ListaPaciente.this);
			ArrayList<Pacientes> paciente = controlPaciente.buscarPacientes(params[0]);
			return paciente;
		}
