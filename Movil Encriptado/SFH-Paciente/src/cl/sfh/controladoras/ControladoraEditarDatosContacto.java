...
public class ControladoraEditarDatosContacto
{
	...
	private String key;
	public ControladoraEditarDatosContacto(Activity actividad)
	{
	...
	{
		mensajeEnviar = "{\"indice\":2,\"rut\":"+rut+",\"key\":\""+key+"\"}";
	...
	public ArrayList<Comunas> obtenerComunas()
	{
		...
		mensajeEnviar = "{\"indice\":7,\"key\":\""+key+"\"}";
		JSONParser parser = new JSONParser();
		List<NameValuePair> parametros = new ArrayList<NameValuePair>();
		parametros.add(new BasicNameValuePair("send", mensajeEnviar));
		JSONObject objetoJson = parser.makeHttpRequest("ws-add-usuario.php","POST", parametros);
	...
	{
		Log.e("Editar Persona", idPersona+"");
		Log.e("Editar Persona", perfil+"");
		Log.e("Editar Persona", rut+"");
		Log.e("Editar Persona", dv+"");
		Log.e("Editar Persona", nombre+"");
		Log.e("Editar Persona", appPaterno+"");
		Log.e("Editar Persona", appMaterno+"");
		Log.e("Editar Persona", fechaNacimiento+"");
		mensajeEnviar = "{\"indice\":5,\"idPersona\":"+idPersona+",\"idPerfil\":"+perfil+",\"rut\":"+rut+",\"dv\":\""+dv+"\",\"nombre\":\""+nombre+"\",\"appPaterno\":\""+appPaterno+"\",\"appMaterno\":\""+appMaterno+"\",\"fechaNac\":\""+fechaNacimiento+"\",\"key\":\""+key+"\"}";
		JSONParser parser = new JSONParser();
		List<NameValuePair> parametros = new ArrayList<NameValuePair>();
		parametros.add(new BasicNameValuePair("send", mensajeEnviar));
	...
	{
		mensajeEnviar = "{\"indice\":8,\"idPersona\":"+idPersona+",\"idComuna\":"+idComuna+",\"fonoFijo\":\""+fonoFijo+"\",\"celular\":\""+fonoCelular+"\",\"direccion\":\""+direccion+"\",\"mail\":\""+mail+"\",\"fechaIngreso\":\""+fechaIngreso+"\",\"key\":\""+key+"\"}";
		JSONParser parser = new JSONParser();
		List<NameValuePair> parametros = new ArrayList<NameValuePair>();
		parametros.add(new BasicNameValuePair("send", mensajeEnviar));
		JSONObject objetoJson = parser.makeHttpRequest("ws-add-usuario.php","POST", parametros);
